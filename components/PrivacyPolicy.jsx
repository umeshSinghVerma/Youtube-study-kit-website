...
const PrivacyPolicy = () => {
  return (
    <div className="p-6 max-w-4xl mx-auto my-10 bg-white shadow-md rounded-lg">
      ...
      <p className="mb-4">
        At Vegah LLC, we value your privacy and are committed to protecting your personal information. This privacy policy explains how we collect, use, and disclose information from our users when they use our Youtube Study Kit browser extension and website.
      </p>
      
      <h2 className="text-xl font-semibold mt-6 mb-2">Information We Collect</h2>
      <ul className="list-disc list-inside mb-4">
        <li>Usage Data: We collect data on how you use Youtube Study Kit, including the videos you tag, the timestamps and screenshots you capture, and your interactions with the extension.</li>
      ...
      <ul className="list-disc list-inside mb-4">
        <li>Providing and Improving Youtube Study Kit: We use your information to provide and improve Youtube Study Kit, including developing new features and improving performance.</li>
        <li>Customer Support: We use your information to respond to your support requests and provide assistance with using Youtube Study Kit.</li>
        <li>Marketing and Promotions: We may use your information to send you updates, promotions, and other marketing materials about Youtube Study Kit.</li>
      </ul>
      
      <h2 className="text-xl font-semibold mt-6 mb-2">YouTube Video Data and User Interactions</h2>
      <ul className="list-disc list-inside mb-4">
        <li>We collect and store YouTube video metadata, including video titles, URLs, and timestamps, solely for the purpose of providing the Youtube Study Kit service.</li>
      ...
      <ul className="list-disc list-inside mb-4">
        <li>Local Storage: Youtube Study Kit stores your data locally on your device, ensuring quick access and privacy.</li>
      ...
      <ul className="list-disc list-inside mb-4">
        <li>Third-Party Services: We may share your information with third-party services that help us operate Youtube Study Kit, such as analytics providers and customer support software.</li>
      ...
      <p className="mb-4">
        If you have any questions about this privacy policy or our data practices, please contact us at <a href="mailto:info@Youtube Study Kit.com" className="text-blue-600">info@Youtube Study Kit.com</a>. We&apos;ll be happy to help!
      </p>
      ...
      <p className="mb-4 font-semibold">
        By using Youtube Study Kit, you acknowledge that you have read, understand, and agree to be bound by this privacy policy.
      </p>
    </div>
  );
}
