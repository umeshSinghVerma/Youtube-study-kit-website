        ...
        <div className="px-[14%] pb-12 pt-24 bg-black flex flex-col text-white">
            ...
            <div className="flex flex-col md:flex-row justify-between">
                <div className="flex flex-col md:flex-row items-center gap-2">
                    <Image src="/Youtube Study Kit-logo.png" alt="Youtube Study Kit" width={40} height={40} />
                    <div className="text-2xl">
                        <p className={oswald.className}>Youtube Study Kit</p>
                    </div>
                </div>
                <div className="text-center">
                    &copy;Youtube Study Kit 2024
                </div>
