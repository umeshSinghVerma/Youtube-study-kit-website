...
const Hero = () => {
    return (
        <div className="flex flex-col items-center justify-center py-[20px] md:py-[80px] px-[30px] text-center">
            ...
            <h1 className="text-xl md:text-5xl leading-[140%] font-[700] mb-[40px] text-[#ed1c24]">Introducing Youtube Study Kit</h1>
            ...
            <Link href="https://chromewebstore.google.com/detail/Youtube Study Kit/ppogfckcfolngoiadhmgflfndgmaijph" className="flex bg-[#fddcdf] p-5 text-left gap-4 rounded-full m-10 w-[260px] h-[71px] items-center justify-center hover:bg-red-300">
